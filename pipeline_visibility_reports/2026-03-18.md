# Chef Pipeline Visibility Report 2026-03-18
...
* [chef/ffi-libarchive](https://github.com/chef/ffi-libarchive)
    * chef-oss/chef-ffi-libarchive-main-verify
* [chef/ffi-yajl](https://github.com/chef/ffi-yajl)
    * chef-oss/chef-ffi-yajl-main-verify
...
Total percentage of private pipelines: 8.13%
  --> 10 out of 123 across 7 repos
  --> Skipped pipelines:
    - chef/chef-automate-main-verify-private
    - chef/chef-chef-main-validate-adhoc
    - chef/chef-chef-main-validate-release
